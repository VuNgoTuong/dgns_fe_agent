<template lang="">
    <div class="modal fade" id="DeleteTenant_Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content p-3 shadow-lg rounded-4 border-top border-start-0 border-end-0 border-bottom-0 border-5 border-danger">
                <div class="modal-body p-4 text-center">
                    <div class="d-flex justify-content-center mb-4">
                        <IconTrash :size="64" stroke-width="1" class="d-flex bg-gradient-danger shadow-danger p-2 rounded-circle cursor-pointer"/>
                    </div>
...
export default {
    ...
    components : {...Icons},
    mounted(){
        modal = new bootstrap.Modal('#DeleteTenant_Modal');
    },
    methods : {
        async _Init(value){
        ...
        DeleteData(){
            ...
            axios.post(PATH_API_USER + '/tenant/delete',params,config)
            .then(async res =>{
                modal.hide()
